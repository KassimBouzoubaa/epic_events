...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        read_clients_parser = subparsers.add_parser('read_clients', help='Read all clients')
        
        # Subparser for read_contracts
        read_contracts_parser = subparsers.add_parser('read_contracts', help='Read all contracts')
        
        # Subparser for read_events
        read_events_parser = subparsers.add_parser('read_events', help='Read all events')
    ...
    def read_clients(self, **kwargs):
        try:
            ...
            self.stdout.write(self.style.ERROR(f'Error retrieving clients: {e}'))
    ...
    def read_contracts(self, **kwargs):
        try:
            ...
            self.stdout.write(self.style.ERROR(f'Error retrieving contracts: {e}'))
